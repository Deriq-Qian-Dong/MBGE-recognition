...
plot_confusion_matrix(cm_normalized, title='Normalized confusion matrix of %s' % data_split_type)
# show confusion matrix
plt.savefig('./%s_TSN_confusion_matrix_sorted.jpg' % data_split_type, format='jpg')
plt.show()
